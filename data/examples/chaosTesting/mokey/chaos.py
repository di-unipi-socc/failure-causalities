...
if __name__ == "__main__":
    ...
    ## Start docker containser
    print("Creating containers...")
    subprocess.call(["docker-compose",  "-f",  dockerComposeFile ,  "up",  "-d",  "--build"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    subprocess.call(["docker-compose",  "-f",  dockerComposeFile,  "down"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    print("Chaos ended")
